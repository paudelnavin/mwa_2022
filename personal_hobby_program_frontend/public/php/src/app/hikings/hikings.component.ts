...
export class RoutePlants{
  ...
  set loation(location:Location){this.#location=location}
}
...
export class Hiking{
  ...
  get routePlants(){return this.#routePlants}
  set routePlants(routePlants:[RoutePlants]){this.#routePlants=routePlants}
